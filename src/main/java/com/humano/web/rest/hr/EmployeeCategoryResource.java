...
import com.humano.service.hr.EmployeeCategoryService;
...
/**
 * REST controller for managing EmployeeCategory reference data.
 */
@RestController
@RequestMapping("/api/hr/employee-categories")
public class EmployeeCategoryResource {

    private static final Logger LOG = LoggerFactory.getLogger(EmployeeCategoryResource.class);
    private static final String ENTITY_NAME = "employeeCategory";
    ...
    public EmployeeCategoryResource(EmployeeCategoryService service) {
    ...
    public ResponseEntity<ReferenceDataResponse> create(@Valid @RequestBody CreateReferenceDataRequest request) throws URISyntaxException {
        LOG.debug("REST request to create EmployeeCategory: {}", request);
        ReferenceDataResponse result = service.create(request);
        return ResponseEntity.created(new URI("/api/hr/employee-categories/" + result.id()))
    ...
    public ResponseEntity<ReferenceDataResponse> update(@PathVariable UUID id, @Valid @RequestBody UpdateReferenceDataRequest request) {
        LOG.debug("REST request to update EmployeeCategory: {}", id);
    ...
    public ResponseEntity<Void> delete(@PathVariable UUID id) {
        LOG.debug("REST request to delete EmployeeCategory: {}", id);
        service.delete(id);
